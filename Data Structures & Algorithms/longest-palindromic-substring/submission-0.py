...
class Solution:
    def longestPalindrome(self, s: str) -> str:
        ...
        for i in range(len(s)):
            longest_odd = expand(s, i, i) # expand from center where center is evenly in middle of palindrome
            longest_even = expand(s, i, i + 1) # expand from center where center is odd in middle of palindrome
