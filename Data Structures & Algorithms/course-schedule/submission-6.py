...
# i actually dont think i need to track max_depth, i just need to check if the DAG has a cycle
# if the DAG has no cycle, we can take all courses, because i wouldnt run into a prereq problem. this is a good piece of intuition to have.
# so let me simplify the code
...
class Solution:
    def canFinish(self, numCourses: int, prerequisites: List[List[int]]) -> bool:
        ...
        def dfs(node: Optional['Node'], cache: set()):
