    ...
    def findRedundantConnection(self, edges: List[List[int]]) -> List[int]:
        ...
        def find(i):
            ...
            if i != p: # if we're not at the parent, keep going up
                parent[i - 1] = find(parent[i - 1]) # set the parent to the parent of the parent, this is path compression
        ...
        def union(a, b):
            ...
            # if the roots dont equal eachother,
            # set b's root to a's root and move on
