...
class Solution:
    def foreignDictionary(self, words: List[str]) -> str:
        ...
        # i want to have this in below iteration but then
        # it would look a bit hairy, plus would fail if there was
        # only 1 word
        for word in words:
            for a in word:
                letters.add(a)
        ...
        # crucial if we found a cycle somewhere in the graph
        return answer if len(answer) == len(letters) else ""
