...
# ok that gets us to 23/28 test cases, but now we're failing at a larger test case that i honestly
# do not have much patience to debug
# triplets=[[15,9,8],[2,4,4],[2,6,1],[10,9,4],[10,4,1],[2,12,11],[1,4,2],[15,1,14],[6,2,9],[4,5,11]]
# target=[10,9,9]
# expected: true, actual: false

# having this test case fails at the end can likely mean i have some one line bug somewhere
# or maybe not, going to think

# yep as expected its a one liner, i think me trusting my initialization as the first element contains 
# smaller triplet values than the target which is not always guarunteed, i simply just need a first pass to
# pick a cur value or maybe i can just initialize the triplet values to negative infinity
class Solution:
